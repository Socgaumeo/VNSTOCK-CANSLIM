...
class AsyncBatchCrawler:
	...
	async def _fetch_rss_async(C,rss_parser:RSS,session:aiohttp.ClientSession)->pd.DataFrame:
	...
	async def _fetch_sitemap_async(C,sitemap_url:str,session:aiohttp.ClientSession)->pd.DataFrame:
