...
class SectorType(Enum):
    """Loại ngành"""
    CYCLICAL = "Cyclical"       # Tài chính, BĐS, Nguyên vật liệu, Công nghiệp
    DEFENSIVE = "Defensive"     # Y tế, Tiện ích, Tiêu dùng thiết yếu
    GROWTH = "Growth"           # Công nghệ, Tiêu dùng không thiết yếu


# Sector classification
SECTOR_TYPES = {
    'VNFIN': SectorType.CYCLICAL,
    'VNREAL': SectorType.CYCLICAL,
    'VNMAT': SectorType.CYCLICAL,
    'VNIND': SectorType.CYCLICAL,
    'VNENERGY': SectorType.CYCLICAL,
    'VNIT': SectorType.GROWTH,
    'VNCOND': SectorType.GROWTH,
    'VNHEAL': SectorType.DEFENSIVE,
    'VNUTI': SectorType.DEFENSIVE,
}

# Rotation Clock mapping - ngành nào dẫn dắt ở giai đoạn nào
ROTATION_LEADERS = {
    RotationClock.EARLY_CYCLE: ['VNFIN', 'VNCOND', 'VNREAL'],
    RotationClock.MID_CYCLE: ['VNIT', 'VNIND', 'VNMAT'],
    RotationClock.LATE_CYCLE: ['VNENERGY', 'VNMAT', 'VNUTI'],
    RotationClock.RECESSION: ['VNUTI', 'VNHEAL', 'VNCOND'],
}
