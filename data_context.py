...
║         (Library/Helper module - không tạo file output)       ║
╚══════════════════════════════════════════════════════════════╝
    """)
    ...
    try:
        ...
        # Print Markdown summary (to console only, no file)
        print("\n" + "="*60)
        print(ctx_analyzer.to_markdown(result))
        
        # Print JSON sample (to console only, no file)
        ...
        print("\n" + "="*60)
        print("✅ Data Context test completed!")
        print("   (Đây là library module - không tạo file output)")
        print("   Sử dụng Module 1 v3 hoặc Module 2-3 v3 để tạo báo cáo.")
